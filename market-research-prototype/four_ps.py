...
def _place_prompt(profile_blob, place_blob, audience_life_context):
    ctx = (
        ...
        "  • NAME the specific channel — not 'B2B partnerships' but the concrete channel "
        "type and WHO it reaches. Name a specific company, publication, outlet or event "
        "ONLY if it appears in the PLACE ANALYSIS or LIFE-CONTEXT data above — a named "
        "outlet the data does not contain is a fabrication the reader will act on "
        "(R6/88b416f6: a prompt example's outlet was copied verbatim into a shipped "
        "report wearing a citation)\n"
